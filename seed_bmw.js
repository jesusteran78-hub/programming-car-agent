...
async function seed() {
    ...
    const entry = (model, start, end, type, copyPrice, lostPrice, desc) => {
        ...
        return [
            { make, model, year_start: start, year_end: endYear, service_type: 'copy', price: copyPrice, description: desc },
            { make, model, year_start: start, year_end: endYear, service_type: 'lost_all', price: lostPrice, description: desc }
        ];
    };
